...
Set the `RSTUDIO_CLOUD_REVDEP_KEY` environment variable to the value of your AWS authentication key.
...
aws configure
```
You will be asked for an access key ID and a secret access key. Follow the instructions at https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html#cli-quick-configuration to create these.
## Usage
